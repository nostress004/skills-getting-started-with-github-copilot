...
def signup_for_activity(activity_name: str, email: str):
    ...
    # Validate activity name is not too short
    if len(activity_name) < 3:
        raise HTTPException(status_code=400, detail="Activity name is too short")
    # Validate activity name is not a number
    if activity_name.isdigit():
        raise HTTPException(status_code=400, detail="Activity name cannot be a number")
